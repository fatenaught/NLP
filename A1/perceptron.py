...
class Perceptron:
    def __init__(self, train_docs, train_labels, MAX_ITERATIONS, dev_docs, dev_labels):
    ...
    def learn(self, train_docs, train_labels):
        ...
        for i in range(self.MAX_ITERATIONS):
            ...
            #best_weights.append((test_acc, train_acc, i, self.copy_weights()))
            #best_weights.sort()
            #best_weight = best_weights[-1][3]
